...
- **Usage**: `/vct set <HH:MM:SS> <timer_id>`
  ...
  - `<timer_id>` - (Optional) Timer ID, [you can find more information here.](../configuration#configuration-of-timers)
- **Examples**:
  - `/vct set 01:25:05`
...
- **Usage**: `/vct modify <modifier> <value>`
  ...
  - `<value>` - A modifier for the timer
    ...
    - `text` - Need a string value in quotation marks, example: "I am a timer :D". Accepts color formats and timer placeholders, [more information here](../configuration#text-and-aim-a-green-timer-of-hh-mm-ss-d)
- **Examples**:
