...
Timer timer = VCTAPI.createTimer("00:00:05", "pvp1", player);
```
...
- At the end of the time:
  - The `TimerEndEvent` event is triggered
...
<ResponseField name="sender" type="CommandSender">
  ...
  - For Java issues, it cannot be completely optional, but passing `null` is valid
</ResponseField>
